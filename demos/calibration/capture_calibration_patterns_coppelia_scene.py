...
The images try to capture the calibrationn pattern in simulation using a simulated camera.
The images are stored in the captures directory.
...
def capture_calibration_patterns():
    ...
    target_positions = [[-0.1, -0.45, 0.55], # ok
                        [-0.1, -0.45, 0.55], # ok
                        [-0.1, -0.45, 0.6], # ok
                        [-0.1, -0.30, 0.6],
                        [-0.1, -0.31, 0.7],
