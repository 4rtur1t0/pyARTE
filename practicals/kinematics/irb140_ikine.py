...
def move_robot(robot, q):
    ...
    for i in range(n_solutions):
        print(i)
        qi = q[:, i]
        robot.moveAbsJ(q_target=qi, precision=True, speed_factor=3.0)
...
def irb140_ikine():
    ...
    target_position = Vector([1.5, 0.3, 0.8])
    ...
    q = robot.inverse_kinematics(target_position=target_position,
