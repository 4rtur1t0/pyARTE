...
def follow_line_obstacle(robot, sphere):
    target_positions = [[0.5, 0.5, 0.55],  # initial in front of conveyor
                        [0.5, -0.5, 0.55]]  # drop the piece on the table
    ...
    robot.set_joint_target_trajectory(q1_path, precision='low')
    robot.set_target_position_orientation(target_positions[1], target_orientations[1])
    robot.set_joint_target_trajectory(q2_path, precision='low')
    robot.wait(15)
