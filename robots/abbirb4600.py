...
# encoding: utf-8
"""
Please open the scenes/irb4600.ttt scene before using this class.

RobotABBIRB4600 is a derived class of the Robot base class that

This is the 40/255 Variant
...
class RobotABBIRB4600(Robot):
    def __init__(self, simulation):
        ...
        joint_ranges = np.array([[-180, -90, -180, -400, -125, -400],
                                 [180,   150,  75,  400,  120, 400]])
        ...
        self.serialrobot.append(th=0, d=0.495, a=0.175, alpha=-np.pi / 2, link_type='R')
        self.serialrobot.append(th=-np.pi/2, d=0, a=0.9, alpha=0, link_type='R')
        self.serialrobot.append(th=0, d=0, a=0.175, alpha=-np.pi / 2, link_type='R')
        self.serialrobot.append(th=0, d=0.96, a=0, alpha=np.pi / 2, link_type='R')
        self.serialrobot.append(th=0, d=0, a=0, alpha=-np.pi / 2, link_type='R')
        self.serialrobot.append(th=np.pi, d=0.135, a=0, alpha=0, link_type='R')

    def start(self, base_name='/IRB4600', joint_name='joint'):
        armjoints = []
