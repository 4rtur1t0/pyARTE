...
class RobotMitsubishiRV8CRL(Robot):
    def __init__(self, simulation):
        ...
        # DH parameters of the robo
        # If link_type is R, then th is th + qi
        ...
        self.serialrobot.append(th=0, d=0.0, a=0.0, alpha=0, link_type='R')
        self.serialrobot.append(th=0, d=0, a=0.0, alpha=0, link_type='R')
        self.serialrobot.append(th=0, d=0, a=0.0, alpha=0, link_type='R')
        self.serialrobot.append(th=0, d=0.0, a=0, alpha=0, link_type='R')
        self.serialrobot.append(th=0, d=0, a=0, alpha=0, link_type='R')
        self.serialrobot.append(th=0, d=0.0, a=0, alpha=0, link_type='R')
